            ...
            <div class="content_l">
            	<div class="fl" id="resume_name">
	            	<div class="nameShow fl">
	            		<h1 title="<?php echo $jianli['jian_name']?>"><?php echo $jianli['jian_name']?></h1>
	            		<span class="rename">重命名</span> | <span name="look">预览</span>
            		</div>
            		<form class="fl dn" id="resumeNameForm">
            			<input type="text" value="<?php echo $jianli['jian_name']?>" name="resumeName" class="nameEdit c9">
            			<input type="submit" value="保存"> | <span name="look">预览</span>
            		</form>
            	</div><!--end #resume_name-->
				<div class="fr c5" id="lastChangedTime">最后一次更新：<span><?php echo date("Y-m-d H:i:s",$jianli['addtime'])?></span></div>
				<div id="resumeScore">
            		<div class="score fl">
            	...
            	<div class="profile_box" id="basicInfo">
            		<h2>基本信息</h2>
					<input type="hidden" id="jian" name="jianli" value="<?php echo $jianli['jianli_id']?>">
            		<span class="c_edit"></span>
            		<div class="basicShow">
            			            			<span><?php echo $jianli['name']?> | <?php echo $jianli['sex']?> |    <?php echo $jianli['nature']?> |  <?php echo $jianli['education']?><br>
            			            			<?php echo $jianli['tell']?> | <?php echo $jianli['email']?><br>
            			</span>
            		...
            		<div class="basicEdit dn">
            			<form id="profileForm">
						  <table>
						    <tbody><tr>
						      ...
						      <td>
						        <input type="text" placeholder="姓名" value="<?php echo $jianli['name']?>" name="name" id="name">
						      </td>
						      <td valign="top"></td> 
						      <td>
						    ...
						    <tr>
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="手机号码" value="<?php echo $jianli['tell']?>" name="tel" id="tel">
						      </td>
						   	</tr>
						   	<tr>
						      <td valign="top">
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="接收面试通知的邮箱" value="<?php echo $jianli['email']?>" name="email" id="email">
						      </td>
						    </tr>
						    <tr>
						      <td valign="top"> </td> 
						    ...
						    <tr>
						      <td></td> 
						      <td colspan="3">
								  <input type="hidden" name="myimg" value="">
						...
						<div class="new_portrait">
						  ...
						  <div class="portraitShow dn" id="portraitShow">
							  <img width="120" height="120" src="<?php echo $jianli['img']?>" name="imgs">
						    <span>更换头像</span>
						  </div>
							<input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" class="myfile" name="img">
					...
					<input type="hidden" id="nameVal" value="<?php echo $jianli['name']?>">
					<input type="hidden" id="genderVal" value="<?php echo $jianli['sex']?>">
					<input type="hidden" id="topDegreeVal" value="<?php echo $jianli['education']?>">
					<input type="hidden" id="workyearVal" value="<?php echo $jianli['year']?>">
					<input type="hidden" id="currentStateVal" value="<?php echo $jianli['status']?>">
					<input type="hidden" id="emailVal" value="<?php echo $jianli['email']?>">
					<input type="hidden" id="telVal" value="<?php echo $jianli['tell']?>">
				...
				<script>
					$(function(){
						$(".myfile").change(function(){
							obj=$(this);
							var fd=new FormData();
							fd.append("myfile",$("input[name='img']").get(0).files[0]);
							$.ajax({
								type:"post",
								url:"?r=user/addimg",
								processData:false,
...
//										alert(str);
									if(str==0){
										...
										$("img[name='imgs']").attr('src',str);
										$("input[name='myimg']").val(str);
				...
				<div class="profile_box" id="expectJob">
            		...
            		<div class="expectEdit dn">
            			<form id="expectForm">
	            			<table>
	            				<tbody><tr>
	            					<td>
	            						...
	            						<input type="hidden" id="expectCity" value="" name="expectCity">
	            													        	<input type="button" value="<?php echo $jianli['city']?>" id="select_expectCity" class="profile_select_287 profile_select_normal">
	            					...
	            					<td>
	            						<ul class="profile_radio clearfix reset">
											<?php
											$nature=array('全职','兼职','实习');
											foreach($nature as $k=>$v){
												if($jianli['nature']==$v){
													echo '<li class="current">'.$v.'<em></em><input type="radio" checked="" name="type" value="'.$v.'"></li> ';
												}else{
													echo '<li>'.$v.'<em></em><input type="radio" checked="" name="type" value="'.$v.'"></li> ';
												}
	            				...
	            				<tr>
	            					<td>
							        	<input type="text" placeholder="期望职位，如：产品经理" value="<?php echo $jianli['hope_work']?>" name="expectPosition" id="expectPosition">
									</td>
	            					<td>
	            						<input type="hidden" id="expectSalary" value="" name="expectSalary">
	            							            						<input type="button" value="<?php echo $jianli['money']?>" id="select_expectSalary" class="profile_select_287 profile_select_normal">
            		...
            		<input type="hidden" id="expectJobVal" value="<?php echo $jianli['hope_work']?>">
            		<input type="hidden" id="expectCityVal" value="<?php echo $jianli['city']?>">
            		<input type="hidden" id="typeVal" value="<?php echo $jianli['nature']?>">
            		<input type="hidden" id="expectPositionVal" value="">
            		<input type="hidden" id="expectSalaryVal" value="<?php echo $jianli['money']?>">
            	</div><!--end #expectJob-->
...
<script>
	$(function(){
		$("span[name='look']").click(function(){
			 var jianli=$("input[name='jianli']").val();
			 location.href="?r=user/look&jianli_id="+jianli;
		})

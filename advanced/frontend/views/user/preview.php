...
<body>
  	<div id="previewWrapper">
		<div class="preview_header">
			<h1 title="<?php echo $info['jian_name']?>"><?php echo $info['jian_name']?></h1>
		...
		<div class="preview_content">
            <div class="profile_box" id="basicInfo">
                <h2>基本信息</h2>
                <div class="basicShow">
                   <span><?php echo $info['name']?> |
                    <?php echo $info['sex']?> |                     <?php echo $info['education']?> |                                       		<?php echo $info['year']?>
            		            			| <?php echo $info['city']?><br>
            			            				<?php echo $info['position_name']?> · <?php echo $info['company_name']?> | <?php echo $info['s_education']?> · <?php echo $info['s_name']?><br>
            			            			<?php echo $info['tell']?> | <?php echo $info['email']?><br>
	                ...
	                <div class="expectShow">
	                	<?php echo $info['city']?>，<?php echo $info['nature']?>，月薪<?php echo $info['money']?>，<?php echo $info['hope_work']?>
	                </div><!--end .expectShow-->
	            </div><!--end #expectJob-->
	                ...
	                <div class="experienceShow">
	                  <ul class="wlist clearfix">
	                  	                    	           				            				<li class="clear">
            					           					<span class="c9"><?php echo $info['e_year']?></span>
	           					<div>
	           						<img width="56" height="56" alt="<?php echo $info['company_name']?>" src="style/images/logo_default.png">
	           						<h3><?php echo $info['position_name']?> </h3>
	           						<h4><?php echo $info['company_name']?></h4>
	           					</div>
	           				</li>
	           					          				                  </ul>
	                ...
	                <div class="projectShow">
	                  <ul class="plist clearfix">
		            					...
		            					<div class="f16 mb10"><?php echo $info['project_name']?>
		            						<span class="c9">
		            									            								（<?php echo $info['p_year']?>）
		            									            						</span>
		            					</div>
		            							            					<div class="dl1"></div>
		            							            				</div>
	                ...
	                <div class="educationalShow">
	                  <ul class="elist clearfix">
	                  	                  	            				            				<li class="clear">
            				            					<span class="c9"><?php echo $info['s_year']?></span>
            					<div>
            						<h3><?php echo $info['s_name']?></h3>
            						<h4><?php echo $info['profession']?>，<?php echo $info['s_education']?></h4>
            					</div>
            				</li>
            				           					                  </ul>
	                ...
	                <div class="workShow">
	                  <ul class="slist clearfix">
            				            					...
            				            					<div class="workList c7">
	            						            							            							<div class="f16">网址：<a target="_blank" href="http://www.weimob.com"><?php echo $info['pro_url']?></a></div>

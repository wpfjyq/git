            ...
            <div class="content_l">
                <dl class="job_detail">
                    <dt>
                        <h1 title="web前端开发">
                            <em></em>
                                        <div>国馆互联网招聘</div><?php echo $data['positionName'] ?>
                        </h1>
                    ...
                    <dd class="job_request">
                    	<span class="red"><?php  echo $data['salary']  ?></span>
                       	<span><?php  echo $data['city']  ?></span>
                       	<span><?php  echo $data['workYear']  ?> </span>
                       	<span> <?php  echo $data['education']  ?></span>
                       	<span><?php  echo $data['jobNature']  ?></span><br>

                        <?php  echo $data['positionAdvantage']  ?>
                      	<div>发布时间：<?php  echo  date('Y-m-d H:i:s',$data['addtime'] ) ?></div>
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                            <?php echo $data['position_desc'] ?>
                    </dd>
...
var options = {
    	...
    	"productImage": ctx+"/uploads/logo/ff80808145ae05750145b0467a1c7ddd.png",

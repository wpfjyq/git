        ...
        <div id="sidebar">
			<div class="mainNavs">
                ...
                foreach($data as $k=>$v){?>
                    <div class="menu_box">
                        <div class="menu_main">
                            <h2><?php echo $v['job_name'] ?><span></span></h2>
                                <?php
                            foreach($v['hot'] as $key=>$vey){?>
                                <a href="?r=index/jobselect&select=<?php echo $vey['job_name'] ?>"><?php echo $vey['job_name'] ?></a>
                           <?php  }
                        ...
                        <div class="menu_sub dn">
                            ...
                            foreach($v['son'] as $kk=>$vv){?>
                                <dl class="reset">
                                    <dt>
                                        <a href="?r=index/jobselect&select=<?php echo $vv['job_name'] ?>&info=two"><?php echo $vv['job_name'] ?></a>
                                    </dt>
                                    <dd>
                                        <?php
                                        foreach($vv['son'] as $kkk=>$vvv){?>
                                            <?php
                                            if(isset($vvv['color'])){ ?>
                                            <a style="color: red" href="?r=index/jobselect&select=<?php echo $vvv['job_name'] ?>"><?php echo $vvv['job_name'] ?></a>
                                           <?php  }else { ?>
                                        <a href="?r=index/jobselect&select=<?php echo $vvv['job_name'] ?>"><?php echo $vvv['job_name'] ?></a>
                                           <?php  }
                                            ?>
                                        <?php }
                                        ?>
                ...
                ?></div>
            <a class="subscribe" href="?r=subsc/index" target="_blank">订阅职位</a>
		</div>
                ...
                <ul class="hot_pos reset">
                    ...
                    <?php foreach($hots as $k=>$v){?>
                        <li class="clearfix">
                            <div class="hot_pos_l">
                                <div class="mb10">
                                    <a href="?r=position/look&position=<?php echo $v['position_id']?>" target="_blank"><?php echo $v['department']?></a>
                                    &nbsp;
                                    <span class="c9">[<?php echo $v['city']?>]</span>
                                </div>
                                <span><em class="c7">月薪： </em><?php echo $v['salary']?></span>
                                <span><em class="c7">经验：</em> <?php echo $v['workYear']?></span>
                                <span><em class="c7">最低学历： </em><?php echo $v['education']?></span>
                                <br />
                                <span><em class="c7">职位诱惑：</em><?php echo $v['positionAdvantage']?></span>
                                <br />
                                <span><?php echo date("Y-m-d H:i:s",$v['addtime'])?></span>
                                <!-- <a  class="wb">分享到微博</a> -->
                            </div>
                            <div class="hot_pos_r">
                                <div class="mb10 recompany"><a href="?r=" target="_blank"><?php echo $v['company_names']?></a></div>
                                <span><em class="c7">领域：</em> <?php echo $v['company_domain']?></span>
                                <span><em class="c7">创始人：</em><?php echo $v['leaderInfosname']?></span>
                                <br />
                                <span><em class="c7">阶段：</em> <?php echo $v['develop_stage']?></span>
                                <span><em class="c7">规模：</em><?php echo $v['company_scale']?></span>
                                <ul class="companyTags reset">
                                    <?php foreach($v['label'] as $key=>$val){?>
                                        <li><?php echo $val?></li>
                                    <?php }?>
                ...
                <ul class="hot_pos hot_posHotPosition reset" style="display:none;">
                    <?php foreach($num as $key=>$val){?>
                        <li class="clearfix">
                            <div class="hot_pos_l">
                                <div class="mb10">
                                    <a href="?r=position/look&position=<?php echo $val['position_id']?>" target="_blank"><?php echo $val['department']?></a>
                                    &nbsp;
                                    <span class="c9">[<?php echo $val['city']?>]</span>
                                </div>
                                <span><em class="c7">月薪： </em><?php echo $val['salary']?></span>
                                <span><em class="c7">经验：</em> <?php echo $val['workYear']?></span>
                                <span><em class="c7">最低学历：</em> <?php echo $val['education']?></span>
                                <br />
                                <span><em class="c7">职位诱惑：</em><?php echo $val['positionAdvantage']?></span>
                                <br />
                                <span><?php echo date("Y-m-d H:i:s",$val['addtime'])?></span>
                                <!-- <a  class="wb">分享到微博</a> -->
                            </div>
                            <div class="hot_pos_r">
                                <div class="mb10"><a href="h/c/8250.html" target="_blank"><?php echo $val['company_names']?></a></div>
                                <span><em class="c7">领域：</em> <?php echo $val['company_domain']?></span>
                                <span><em class="c7">创始人：</em><?php echo $val['leaderInfosname']?></span>
                                <br />
                                <span> <em class="c7">阶段： </em><?php echo $val['develop_stage']?></span>
                                <span> <em class="c7">规模：</em><?php echo $val['company_scale']?></span>
                                <ul class="companyTags reset">																<?php foreach($val['label'] as $kk=>$vv){?>
                                        <li><?php echo $vv;?></li>
                                    <?php }?>

...
<div id="body">
    <div id="container">
        ...
        <div class="content">
            <div id="search_box">
                <form id="" name="" action="?r=index/jobselect" method="post">
                    <ul id="searchType">
                ...
                foreach($data as $k=>$v){?>
                    <ul class="hot_pos reset">
                        <li class="odd clearfix">
                            <div class="hot_pos_l">
                                <div class="mb10">
                                    <a href="?r=index/joblist&position_id=<?php echo $v['position_id'] ?>" title="<?php echo $v['positionName'] ?>" target="_blank"><?php echo $v['positionName'] ?></a>
                                    &nbsp;
                            ...
                            <div class="hot_pos_r">
                                <div class="apply">
                                    <a href="?r=user/check" target="_blank">去公司页投简历</a>
                                </div>
                                <div class="mb10"><a href="h/c/1712.html" title="紫色医疗" target="_blank"><?php  echo $v['company_name'] ?></a></div>

...
<!--	                    <a class="btn_cancel fr" href="?r=company/detail_3&company_id=--><?php //echo $company_id ?><!--&status=2">跳过</a>-->
...
<script>
    $("#step2Submit").click(function () {
        ...
        $("ul[id='labels'] li span").each(function () {
            str+=','+$(this).html();
        })
        str = str.substr(1);
        $.ajax({
            type: "POST",
            url: "?r=company/detail_two_upd",
            data:{
            ...
            success: function(msg){
                if(msg!=0){
                    alert('完善成功');
                    location.href='?r=company/detail_3&company_id='+company_id
                }
            }
        });
    })

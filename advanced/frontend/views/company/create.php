            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<form method="post" id="jobForm" action="?r=company/positionadd">
							<input type="hidden" value="<?php echo $ids['company_id']?>" name="company_id">
							<table class="btm">
                            	<tbody><tr>
		...
		<tr>
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                                	<td>职位描述</td>
                                	<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span></td>
                                </tr>
								<tr>
									<td colspan="3">
										<script id="editor" type="text/plain" name='position_desc' style="width:650px;height:300px;"></script>
									</td>
								</tr>
                                <tr>
                                	<td><span class="redstar">*</span></td>
...
<!--                            			<input type="hidden" value="" name="positionLat" id="lat">-->
                            ...
                            <table>
                            	<tbody><tr>
                                	<td width="25"><span class="redstar">*</span></td>
                                	<td colspan="2">
                                    	接收简历邮箱： <span id="receiveEmailVal"><?php echo $ids['company_email']?></span>
                                        <input type="hidden" value="<?php echo $ids['company_email']?>" id="receiveEmail" name="email">
                                    </td>
                                </tr>
                                <tr>
                                	<td width="25"></td>

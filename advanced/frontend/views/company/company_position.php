...
<div id="company_navs" class="company_navs">
    <div class="company_navs_wrap">
        <ul data-pjax="">
            ...
            <li>
                <a href="2" data-lg-tj-id="9100" data-lg-tj-no="0002" data-lg-tj-cid="idnull">招聘职位（   <?php echo $num ?>）</a>
            </li>
            <li>
...
<div class="item_container" id="company_products">
    <div class="item_ltitle">公司职位</div>
<!--    循环-->

    <?php
        foreach($job as $k=>$v){?>
            <div>
                <p style="font-size: 18px;"><?php echo $v['positionName'] ?></span></p>
                <p><span><?php echo $v['positionAddress'] ?></span>&nbsp;&nbsp;&nbsp;<span><?php echo $v['salary'] ?></span></p>
            </div>

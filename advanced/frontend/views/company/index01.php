    ...
    <div id="container">
        ...
        <div class="content_mid">
        	<dl class="c_section c_section_mid">
                ...
                <dd>
	                <form id="" method="post" action="?r=company/detail_t">
	                    ...
	                    <h3>公司全称 <span><?php echo $company['company_name'] ?></span></h3>
	                    
	                    <h3>公司简称</h3> <!--非必填-->
	                    <input type="text" placeholder="请输入公司简称，如:拉勾" value="" name="company_names" id="name" class="valid">
...
<!--	                    </div>-->
	                    ...
	                    <h3>公司网址</h3>
	                    <input type="text" placeholder="请输入公司网址" value="" name="company_url" id="website">
	                    
	                    <h3>所在城市</h3>
	                    <input type="text" placeholder="请输入工作城市，如：北京" name="company_city" id="city">
	                    
	                    <h3>行业领域</h3>
	                    <div>
		                    <input type="hidden" value="" name="company_domain" id="select_industry_hidden">
		                    		                    	<input type="button" value="请选择行业领域" name="company_domain" id="select_industry" class="select">
	                    ...
	                    <h3>发展阶段</h3> 
	                    <div>
		                    <input type="hidden" id="s_radio_hidden" name="develop_stage" value="">
	                    ...
	                    <h3>一句话介绍</h3> 
	                    <input type="text" placeholder="一句话概括公司亮点，如公司愿景、领导团队等，限50字" maxlength="50" name="company_bright" id="temptation">
	                    <span style="display:none;" class="error" id="beError"></span>
                        <input type="text" name="info" value="<?php echo $info ?>"/>
	                    <input type="hidden" id="companyId" name="company_id" value="<?php  echo $company['company_id'] ?>">
                        <a class="btn_cancel fr" href="?r=company/detail_2&company_id=<?php echo  $company['company_id'] ?>&status=1">跳过</a>

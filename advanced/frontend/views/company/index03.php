        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form method="post" action="?r=company/detail_s_upd" id="memberForm">
                        <div id="memberDiv">
		                    <div class="formWrapper">
		                        ...
		                        <h3>当前职位</h3>
		                        <input type="text" placeholder="请输入当前职位，如：创始人兼CEO" name="leaderInfosposition[]" id="position0" class="s_input1 valid">
		                        
		                        <h3>新浪微博</h3>
		                        <input type="text" placeholder="请输入创始人新浪微博地址" name="leaderInfosweibo[]" id="weibo0">
                    	...
                    	<a class="btn_cancel fr" href="?r=company/detail_4&company_id=<?php echo $company_id ?>&status=3">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>

                ...
                <form id="subForm"  >
	                ...
	                <div class="s_form">
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="text" id="subEmail" res="yes" name="email" placeholder="请输入接收邮箱" value="" />
	                        	<span id="emailError" class="error" style="display:none;">请输入接收邮箱</span>
	                        </dd>
	                        <dd>
	                        	<input type="hidden" res="yes" id="select_day_hidden" name="sendMailPer" value="" />
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="hidden" res="yes" id="select_job_hidden" name="positionName" value="" />
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="hidden" res="yes" id="select_stage_hidden" name="financeStage" value="" />
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="hidden" res="yes" id="select_industry_hidden" name="industryField" value="" />
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="hidden" res="yes" id="select_salary_hidden" name="salary" value="" />
